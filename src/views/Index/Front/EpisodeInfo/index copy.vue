                        ...
                        <span class="drop-down-list">
                            <el-dropdown>
                                ...
                                <el-dropdown-menu slot="dropdown" >
                                    ...
                                    <el-dropdown-item v-for="item in testdetail[0].episode"  @click.native.prevent.stop="goPath1('reserveinfo',testdetail[0].test_id,item)" >
...
export default {
    ...
    computed: {
        ...mapGetters(['identity', 'echarts_info', 'get_time_arr', 'get_time_val_arr', 'get_time_dict','userinfo','testdetail']),
        getUsername() {
