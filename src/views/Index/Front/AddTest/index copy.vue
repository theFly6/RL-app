        ...
        <el-dialog title="修改实验信息" :visible.sync="testUpdateDialog">
         ...
         <el-dialog title="实验参数" :visible.sync="testDetailDialog">
            <el-form ref="testDetailForm" :model="testDetailForm" label-width="80px" :rules="rules"
                hide-required-asterisk>
                <el-form-item label="实验名"  prop="test_name">
                    <el-input v-model.trim="testDetailForm.test_name" autocomplete="off"
                        placeholder="请输入实验名"></el-input>
                </el-form-item>
                <el-form-item label="实验者" prop="user_name">
                    <el-input v-model.trim="testDetailForm.user_name" autocomplete="off" placeholder="请输入实验者">
                    </el-input>
                </el-form-item>
        
                <el-form-item label="用户状态" prop="test_status">
                    <el-radio-group v-model="testDetailForm.test_status">
                        <el-radio :label="test_status[1].label"></el-radio>
                        <el-radio :label="test_status[2].label"></el-radio>
                    </el-radio-group>
                </el-form-item>
